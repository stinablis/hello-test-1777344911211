...
export default function Home() {
  ...
  const products = [{ n: 'test', d: 'Our \'test\' product is a revolutionary solution designed to streamline processes and increase efficiency, providing users with a seamless experience. With its advanced features and user-friendly interface, it\'s an ideal choice for businesses and individuals alike.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'test', d: 'The \'test\' product offers a unique combination of functionality and flexibility, allowing users to customize it to meet their specific needs. Its robust features and scalability make it an excellent option for organizations seeking to grow and expand.', i: 'https://images.pexels.com/photos/5342564/pexels-photo-5342564.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'test', d: 'Our \'test\' product is a groundbreaking innovation that sets a new standard in its class, providing unparalleled performance and reliability. With its cutting-edge technology and sleek design, it\'s sure to impress even the most discerning users.', i: 'https://images.pexels.com/photos/5342564/pexels-photo-5342564.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'test', d: 'The \'test\' product is a feature-rich solution that provides users with a comprehensive range of tools and features, making it an excellent choice for those seeking an all-in-one solution. Its intuitive interface and exceptional support make it easy to use and maintain.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'test', d: 'Our \'test\' product is a specialized solution designed to address specific needs and challenges, offering a tailored approach that sets it apart from other products in its category. With its unique features and exceptional value, it\'s an attractive option for users seeking a customized solution.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Hello Test, we are dedicated to providing innovative products that meet the evolving needs of our customers. With a commitment to quality and excellence, we strive to deliver exceptional value to our clients. Our team of experts is passionate about creating solutions that make a meaningful impact.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To be a leading provider of cutting-edge products that transform the way people live and work.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To design, develop, and deliver high-quality products that exceed customer expectations and build long-term relationships.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">tets</h4>
                  <p className="text-sm text-on-surface-variant">Our first core value, \'tets\', represents our dedication to continuous learning and improvement, ensuring we stay ahead of the curve in our industry.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">test</h4>
                  <p className="text-sm text-on-surface-variant">Our second core value, \'test\', reflects our commitment to collaboration and teamwork, recognizing that together, we can achieve more than alone.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/10923104/pexels-photo-10923104.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/19747906/pexels-photo-19747906.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/34804010/pexels-photo-34804010.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
